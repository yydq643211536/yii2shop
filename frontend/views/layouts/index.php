...
<div class="header w1210 bc mt15">
                ...
                <dd>
                    ...
                    <div class="viewlist mt10">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href=""><?=Html::img('@web/images/view_list2.jpg')?></a>
                            </li>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl">
            ...
            <div class="cat_bd">
<!--                --><?php //foreach (\backend\models\GoodsCategory::find()->where(['parent_id'=>0])->all() as $model):?>
<!--                <div class="cat ">-->
<!---->
<!--                    <h3> --><?php
//                        echo \yii\bootstrap\Html::a($model->name,['list/list','id'=>$model->id],['class'=>'btn btn-warning btn-xs']);
//
//                        ?><!-- <b></b></h3>-->
<!---->
<!--                    <div class="cat_detail">-->
<!--                        --><?php //foreach (\backend\models\GoodsCategory::find()->where(['parent_id'=>$model->id])->all() as $mode):?>
<!--                        <dl class="dl_1st">-->
<!---->
<!--                            <dt> --><?php
//                                echo \yii\bootstrap\Html::a($mode->name,['list/list','id'=>$mode->id],['class'=>'btn btn-warning btn-xs']);
//
//                                ?><!--</dt>-->
<!--                            <dd>-->
<!--                        --><?php //foreach (\backend\models\GoodsCategory::find()->where(['parent_id'=>$mode->id])->all() as $mod):?>
<!--                            --><?php
//                            echo \yii\bootstrap\Html::a($mod->name,['list/list','id'=>$mod->id],['class'=>'btn btn-warning btn-xs']);
//
//                            ?>
<!---->
<!--                        --><?php //endforeach;?>
